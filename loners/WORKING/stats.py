...
class StatsScript:
    ...
    def show_basic_stats(self):
        ...
        # Likes-based categories (based on runtime avg)
        ...
        stats_table.add_row("Bombers", str(len(cat_bomber)), f"≤ {half:.1f} likes")
        stats_table.add_row("Mid", str(len(cat_mid)), f"~ avg ({avg_likes_runtime:.1f})")
        stats_table.add_row("Bangers", str(len(cat_banger)), f"≥ {double:.1f} likes")
        stats_table.add_row("Viral", str(len(cat_viral)), "≥ 2000 likes")
